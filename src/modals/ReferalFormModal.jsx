...
export default function ReferalFormModal() {
  ...
  return (
    <>
      {isReferalFormOpen ? (
        <div className=" bg-black/90 dark:bg-white/60 w-screen absolute  z-50 bottom-0 top-0 left-0 right-0">
          <Container>
            <div className="h-[32rem] overflow-y-scroll  p-3 fixed top-20 md:top-30 md:p-5 right-0 left-0 rounded-sm bg-white/90 dark:bg-black w-[85%] mx-auto max-w-7xl ">
              <button
